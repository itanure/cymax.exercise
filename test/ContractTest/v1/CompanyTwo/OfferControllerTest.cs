...
using ContractTests.v1.CompanyTwo.Contracts;
...
namespace ContractTests.v1.CompanyTwo
{
    ...
    public class OfferControllerTest : IClassFixture<TestFixture<FakeStartupForTests>>
    {
        ...
        [Trait("CompanyTwo", "GetBestDeal - v1")]
        public async Task ShouldReturnSameContractProviderAndConsumer()
        {
            // Arrange
            var consumerContract = OfferContracts.Request.Consumer.OfferCompanyTwoStatus200.ReadAsString();
